...
trait HttpBehavior {
  ...
  val projectPageArtifactQuery: (String, String, Option[String], Option[String], Option[String], Option[UserState]) => StandardRoute
  ...
  val releaseInfoApi: (String, String, Option[String], Option[String], Option[String], Option[String], Option[String]) => StandardRoute
  val autocomplete: (String) => StandardRoute
  val versionBadge: (String, String, String, Option[String], Option[String], Option[String], Option[String], Option[Int]) => Route
